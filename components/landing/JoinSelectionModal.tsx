                        ...
                        <div className="p-5 sm:p-6">
                            ...
                            <div className="text-center mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-slate-100">
                                <p className="text-slate-400 font-bold text-[9px] sm:text-[10px] uppercase tracking-[0.2em]">
                                    Already have an account? <Link href="/login" onClick={onClose} className="text-slate-900 font-bold hover:text-indigo-600 transition-colors underline-offset-4">Log in here</Link>
                                </p>
                            </div>
                        </div>
                    </motion.div>
