...
export default async function CreatorDashboardPage({
  ...
  const avgEngagement = (igMetric?.engagementRate || ytMetric?.engagementRate || 12);

  const userName = creator.fullName || "Alex";
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Your engagement is up {avgEngagement}% this week. Three new brands are waiting for your approval.
              </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 bg-white rounded-lg p-1 border border-gray-200">
                <Button variant="ghost" size="sm" className="text-cyan-500 bg-cyan-50 hover:bg-cyan-100">
              ...
              <div className="flex items-center gap-2">
                <Button variant="outline" size="sm" className="bg-white border-gray-200 text-gray-600">
                  Last 30 Days
                </Button>
                <Button variant="outline" size="sm" className="bg-white border-gray-200 text-gray-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="rounded-2xl border-gray-100 shadow-sm p-6">
            ...
            <div className="flex items-end gap-2">
              <h3 className="text-3xl font-bold text-gray-900">14 <span className="text-lg text-gray-400 font-normal">Contracts</span></h3>
          ...
          <Card className="rounded-2xl border-gray-100 shadow-sm p-6">
            ...
            <div className="flex items-end gap-2">
              <h3 className="text-3xl font-bold text-gray-900">+{Math.floor(latestFollowers / 1000)}k</h3>
              <span className="text-sm font-bold text-green-600 mb-1">+{followerGrowth}%</span>
            </div>
          </Card>
        </div>
