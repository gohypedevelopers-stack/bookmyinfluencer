        ...
        <div className="relative flex-1 flex flex-col">
          ...
          <Container className="pt-24 pb-32 relative z-10 flex-1 flex flex-col justify-center">
            ...
            <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-4xl mx-auto w-full">
              ...
              >
                <div className="absolute -inset-0.5 bg-slate-200/50 rounded-[2.5rem] blur-xl opacity-60"></div>
                <div className="relative h-full bg-white/80 backdrop-blur-xl border border-slate-200/80 rounded-[2.5rem] p-8 md:p-10 shadow-lg shadow-emerald-900/5 flex flex-col items-center text-center overflow-hidden transition-all duration-300 hover:shadow-xl hover:shadow-emerald-900/10 hover:-translate-y-1 border-white/50">
                  
                  {/* Decorative background glow */}
                  <div className="absolute top-0 right-0 w-48 h-48 bg-emerald-50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />

                  <div className="w-20 h-20 rounded-2xl bg-emerald-50/80 flex items-center justify-center mb-6 shadow-sm border border-emerald-100/50 transition-colors duration-300 group-hover:bg-emerald-100/50">
